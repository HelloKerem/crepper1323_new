...
## Well roblox made their moderation system
# s o
## strict that even my modules that LITERALLY FOLLOWS THE "Creator Store requirements" RULES get disabled, i had to use bypass to make them loadable via require()
